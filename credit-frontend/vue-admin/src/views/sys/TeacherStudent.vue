<template>
  <div class="student">
    ...
    >
      ...
      <el-table-column prop="grade" label="校届"> </el-table-column>
    ...
    width="30%">
        <el-form ref="form" :model="studentInfoEdit" label-width="120px">
        <el-form-item label="学生姓名">
            <el-input v-model="studentInfoEdit.name"></el-input>
        </el-form-item>
        <el-form-item label="学生学号">
            <el-input v-model="studentInfoEdit.id"></el-input>
        </el-form-item>
        <el-form-item label="学生校届选择">
            <el-select v-model="studentInfoEdit.grade" placeholder="请选择校届">
        ...
        <el-form-item label="联系邮箱">
            <el-input v-model="studentInfoEdit.mail"></el-input>
        </el-form-item>
        <el-form-item label="所在学院">
            <el-input v-model="studentInfoEdit.academy"></el-input>
        </el-form-item>
        <el-form-item label="专业班级">
            <el-input v-model="studentInfoEdit.major"></el-input>
        </el-form-item>
        <el-form-item label="身份证号">
            <el-input v-model="studentInfoEdit.card"></el-input>
        </el-form-item>
        <el-form-item label="密码">
            <el-input v-model="studentInfoEdit.password"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    width="30%">
        <el-form ref="form" :model="studentInfoAdd" label-width="80px">
        <el-form-item label="学生姓名">
            <el-input v-model="studentInfoAdd.name"></el-input>
        </el-form-item>
        <el-form-item label="学生学号">
            <el-input v-model="studentInfoAdd.id"></el-input>
        </el-form-item>
        <el-form-item label="学生校届选择">
            <el-select v-model="studentInfoAdd.grade" placeholder="请选择校届">
            <el-option label="大一" value="大一"></el-option>
            <el-option label="大二" value="大二"></el-option>
            <el-option label="大三" value="大三"></el-option>
            <el-option label="大四" value="大四"></el-option>
        ...
        <el-form-item label="联系邮箱">
            <el-input v-model="studentInfoAdd.mail"></el-input>
        </el-form-item>
        <el-form-item label="所在学院">
            <el-input v-model="studentInfoAdd.academy"></el-input>
        </el-form-item>
        <el-form-item label="专业班级">
            <el-input v-model="studentInfoAdd.major"></el-input>
        </el-form-item>
        <el-form-item label="身份证号">
            <el-input v-model="studentInfoAdd.card"></el-input>
        </el-form-item>
        <el-form-item label="密码">
            <el-input v-model="studentInfoAdd.password"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-dialog
      ...
      <!-- 插入表格 -->
        <el-button style="float:right;margin-bottom: 20px;" type="primary" @click="dialogVisible4AddRecord = true;">新增该生学习记录</el-button>
        <el-table
          :data="tableData4Info"
          style="width: 100%"
...
<!-- 新增学生学习记录 -->
 <el-dialog
    title="新增记录"
    :visible.sync="dialogVisible4AddRecord"
    width="30%">
        <el-form ref="form" :model="courseInfo" label-width="100px">
        <el-form-item label="课程号">
            <el-input v-model="courseInfo.id"></el-input>
        </el-form-item>
        <el-form-item label="课程中文名">
            <el-input v-model="courseInfo.chineseName"></el-input>
        </el-form-item>
        <el-form-item label="课程英文名">
            <el-input v-model="courseInfo.englishName"></el-input>
        </el-form-item>
        <el-form-item label="获得学分">
            <el-input v-model="courseInfo.credits"></el-input>
        </el-form-item>
        <el-form-item label="成绩">
            <el-input v-model="courseInfo.grade"></el-input>
        </el-form-item>
        <el-form-item>
            <el-button type="primary" @click="concreteAddRecord">确认添加</el-button>
...
export default {
  ...
  methods: {
    getAll() {
      this.$axios.get("http://localhost:8081/students").then((res) => {
    ...
    searchStudent() {
      ...
      //   this.tableData = res.data.data;
      // });
      this.$axios.get('http://localhost:8081/students/'+this.studentName).then(res=>{
    ...
    handleEdit(idx, row) {
      //编辑此行数据
      this.studentInfoEdit = this.tableData[idx];
      this.dialogVisible4Edit = true;
    },
    //确认编辑结果
    concreteEdit() {
      this.$axios.put("http://localhost:8081/students", this.studentInfoEdit).then((res) => {
    ...
    concreteAdd() {
      //确认添加
      //添加操作
      this.$axios.post("http://localhost:8081/students", this.studentInfoAdd).then(res=>{
    ...
    concreteAddRecord() {
      //添加操作
      this.tableData4InfoFOOL.push(this.courseInfo);
      this.tableData4Info = this.tableData4InfoFOOL;
      this.dialogVisible4AddRecord = false;
    },
    cancelAddRecord() {
      //取消操作
      this.dialogVisible4AddRecord = false;
    ...
    handleDelete(idx, row) {
      ...
      this.$confirm("确定删除此人信息？", "警示", "{type: warning}")
        .then(() => {
          //确定删除
          this.$axios.delete("http://localhost:8081/students",{data: row}).then(res=>{
            console.log(res);
            if(res.data.code === 200) {
    ...
    deleteMany() {
      if (this.multipleSelection.length > 0) {
        for (let student of this.multipleSelection) {
          //删除每个选中的学生
          this.$axios.delete("http://localhost:8081/students",{data: student}).then(res=>{
